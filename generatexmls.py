...
def genXML(vid,avgcnt,avgcntrece,genres_levels,artistNameFromArtist,artistId):
	try:
		global opdir
		artistMatch = 0.0
		percentMatch = 0.0
...
def generatexmls(dirlist):
	...
	#for d in dirlist:
		...
		try:
			...
			logging.exception("Missing genres for Artist:")	
		...
		try:
			...
			logging.exception("Missing styles for Artist:")	
		...
		for v in vids:
			...
			#print "ttt in vids=========================================================================================="
			#print ttt
			genXML(v,avgcnt,avgcntrece,genres_levels,artistNameFromArtist,artistId)
