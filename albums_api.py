...
#
# Generated Wed Mar 19 21:15:28 2014 by generateDS.py version 2.9a.
#
...
class songs(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, Id=None, artistId=None, overLap=None, songName=None, youtubeName=None, artist=None, ftArtistList=None, connPhraseList=None, indexedArtist=None, url=None, releaseDate=None, decade=None, youtubeDate=None, crawlDate=None, viewcount=None, rating=None, genre=None, subgenre=None, styles=None, albumList=None, viewcountRate=None, duration=None, descriptions=None, viewCountGroup=None, decision=None, substring_song=None, substring_artist=None, substring_ftartist=None, songLanguage=None, earliestDate=None, songCountry=None, totalMatch=None, songMatch=None, artistMatch=None, youtubeList=None):
        self.Id = Id
    ...
    def get_styles(self): return self.styles
    def set_styles(self, styles): self.styles = styles
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='songs', fromsubclass_=False, pretty_print=True):
        ...
        if self.genre is not None:
            self.genre.export(outfile, level, namespace_, name_='genre', pretty_print=pretty_print)
        if self.subgenre is not None:
            self.subgenre.export(outfile, level, namespace_, name_='subgenre', pretty_print=pretty_print)
        if self.styles is not None:
            self.styles.export(outfile, level, namespace_, name_='styles', pretty_print=pretty_print)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.genre is not None:
            showIndent(outfile, level)
            outfile.write('genre=model_.genre(\n')
            self.genre.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.subgenre is not None:
            showIndent(outfile, level)
            outfile.write('subgenre=model_.subgenre(\n')
            self.subgenre.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.styles is not None:
            showIndent(outfile, level)
            outfile.write('styles=model_.styles(\n')
            self.styles.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.albumList is not None:
            showIndent(outfile, level)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Id':
            ...
            obj_.build(child_)
            self.set_genre(obj_)
        elif nodeName_ == 'subgenre':
            obj_ = subgenre.factory()
            obj_.build(child_)
            self.set_subgenre(obj_)
        elif nodeName_ == 'styles':
            obj_ = styles.factory()
            obj_.build(child_)
            self.set_styles(obj_)
...
class genre(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, level1Genres=None):
        if level1Genres is None:
            self.level1Genres = []
        else:
    ...
    def add_level1Genres(self, value): self.level1Genres.append(value)
    def insert_level1Genres(self, index, value): self.level1Genres[index] = value
    def hasContent_(self):
        if (
            self.level1Genres
            ):
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='genre', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='genre')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='genre'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='genre', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for level1Genres_ in self.level1Genres:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%slevel1Genres>%s</%slevel1Genres>%s' % (namespace_, self.gds_format_string(quote_xml(level1Genres_).encode(ExternalEncoding), input_name='level1Genres'), namespace_, eol_))
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('level1Genres=[\n')
        level += 1
        for level1Genres_ in self.level1Genres:
            showIndent(outfile, level)
            outfile.write('%s,\n' % quote_python(level1Genres_).encode(ExternalEncoding))
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
    def build(self, node):
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'level1Genres':
            level1Genres_ = child_.text
            level1Genres_ = self.gds_validate_string(level1Genres_, node, 'level1Genres')
            self.level1Genres.append(level1Genres_)
# end class genre


class subgenre(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, level2Genres=None):
        if level2Genres is None:
            self.level2Genres = []
        else:
            self.level2Genres = level2Genres
    def factory(*args_, **kwargs_):
        if subgenre.subclass:
            return subgenre.subclass(*args_, **kwargs_)
        else:
            return subgenre(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_level2Genres(self): return self.level2Genres
    def set_level2Genres(self, level2Genres): self.level2Genres = level2Genres
    def add_level2Genres(self, value): self.level2Genres.append(value)
    def insert_level2Genres(self, index, value): self.level2Genres[index] = value
    def hasContent_(self):
        if (
            self.level2Genres
            ):
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='subgenre', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='subgenre')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='subgenre'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='subgenre', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for level2Genres_ in self.level2Genres:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%slevel2Genres>%s</%slevel2Genres>%s' % (namespace_, self.gds_format_string(quote_xml(level2Genres_).encode(ExternalEncoding), input_name='level2Genres'), namespace_, eol_))
    def exportLiteral(self, outfile, level, name_='subgenre'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('level2Genres=[\n')
        level += 1
        for level2Genres_ in self.level2Genres:
            showIndent(outfile, level)
            outfile.write('%s,\n' % quote_python(level2Genres_).encode(ExternalEncoding))
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
    def build(self, node):
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'level2Genres':
            level2Genres_ = child_.text
            level2Genres_ = self.gds_validate_string(level2Genres_, node, 'level2Genres')
            self.level2Genres.append(level2Genres_)
# end class subgenre


class styles(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, level3Genres=None):
        if level3Genres is None:
            self.level3Genres = []
        else:
            self.level3Genres = level3Genres
    def factory(*args_, **kwargs_):
        if styles.subclass:
            return styles.subclass(*args_, **kwargs_)
        else:
            return styles(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_level3Genres(self): return self.level3Genres
    def set_level3Genres(self, level3Genres): self.level3Genres = level3Genres
    def add_level3Genres(self, value): self.level3Genres.append(value)
    def insert_level3Genres(self, index, value): self.level3Genres[index] = value
    def hasContent_(self):
        if (
            self.level3Genres
            ):
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='styles', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='styles')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='styles'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='styles', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for level3Genres_ in self.level3Genres:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%slevel3Genres>%s</%slevel3Genres>%s' % (namespace_, self.gds_format_string(quote_xml(level3Genres_).encode(ExternalEncoding), input_name='level3Genres'), namespace_, eol_))
    def exportLiteral(self, outfile, level, name_='styles'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('level3Genres=[\n')
        level += 1
        for level3Genres_ in self.level3Genres:
            showIndent(outfile, level)
            outfile.write('%s,\n' % quote_python(level3Genres_).encode(ExternalEncoding))
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
    def build(self, node):
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'level3Genres':
            level3Genres_ = child_.text
            level3Genres_ = self.gds_validate_string(level3Genres_, node, 'level3Genres')
            self.level3Genres.append(level3Genres_)
# end class styles
...
class video(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, youtubeId=None, startTime=None, endTime=None, totalTime=None, viewcountRate=None, viewcount=None, rating=None):
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from albums_api import *\n\n')
    sys.stdout.write('from datetime import datetime as datetime_\n\n')
    sys.stdout.write('import albums_api as model_\n\n')
